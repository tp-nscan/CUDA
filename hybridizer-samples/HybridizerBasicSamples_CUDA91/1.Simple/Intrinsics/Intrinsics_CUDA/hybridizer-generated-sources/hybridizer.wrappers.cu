...
// Intrinsic type half2 used
#define __TYPE_DECL_half2__
#include <cuda_fp16.h>
namespace Intrinsics { 
...
{
	if (strcmp (fullTypeName, "Hybridizer.Runtime.CUDAImports.half2") == 0) return 1000000 ; 
	if (strcmp (fullTypeName, "Intrinsics.Program") == 0) return 1000001 ; 
	if (strcmp (fullTypeName, "System.Action<System.Int32>") == 0) return 1000002 ; 
	if (strcmp (fullTypeName, "System.Nullable<System.Int64>") == 0) return 1000003 ; 
	if (strcmp (fullTypeName, "System.Object") == 0) return 1000004 ; 
	if (strcmp (fullTypeName, "System.Threading.Tasks.Parallel") == 0) return 1000005 ; 
	if (strcmp (fullTypeName, "System.Threading.Tasks.ParallelLoopResult") == 0) return 1000006 ; 
	return 0 ;
}
extern "C" DLL_PUBLIC const char* HybridizerGetTypeFromID( const int typeId)
{
	if (typeId == 1000000) return "Hybridizer.Runtime.CUDAImports.half2" ; 
	if (typeId == 1000001) return "Intrinsics.Program" ; 
	if (typeId == 1000002) return "System.Action<System.Int32>" ; 
	if (typeId == 1000003) return "System.Nullable<System.Int64>" ; 
	if (typeId == 1000004) return "System.Object" ; 
	if (typeId == 1000005) return "System.Threading.Tasks.Parallel" ; 
	if (typeId == 1000006) return "System.Threading.Tasks.ParallelLoopResult" ; 
	return "" ;
}
extern "C" DLL_PUBLIC int HybridizerGetShallowSize (const char* fullTypeName) 
{
	#ifdef __TYPE_DECL_half2__
	if (strcmp (fullTypeName, "Hybridizer.Runtime.CUDAImports.half2") == 0) return 4 ; 
	#endif
	#ifdef __TYPE_DECL__Intrinsics_Program___
	if (strcmp (fullTypeName, "Intrinsics.Program") == 0) return 8 ; 
	#endif
...
extern "C" DLL_PUBLIC int Intrinsicsx46Programx46Compute_ExternCWrapper_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  half2* const input,  int N)
{
	CUresult cures ;                                                                                 
	...
	cures = cuModuleGetFunction (&__hybridizer__cufunc, __hybridizer__gs_module.module, "Intrinsicsx46Programx46Compute") ;   
	if (cures != CUDA_SUCCESS) return (int)cures ;                                                   
	...
	void* __hybridizer_launch_config[4] = 
		{
