...
{
	if (strcmp (fullTypeName, "HybC.Program") == 0) return 1000000 ; 
	if (strcmp (fullTypeName, "System.Console") == 0) return 1000001 ; 
	if (strcmp (fullTypeName, "System.IFormatProvider") == 0) return 1000002 ; 
	if (strcmp (fullTypeName, "System.IO.TextWriter") == 0) return 1000003 ; 
	if (strcmp (fullTypeName, "System.Object") == 0) return 1000004 ; 
	if (strcmp (fullTypeName, "System.String") == 0) return 1000005 ; 
	return 0 ;
}
extern "C" DLL_PUBLIC const char* HybridizerGetTypeFromID( const int typeId)
{
	if (typeId == 1000000) return "HybC.Program" ; 
	if (typeId == 1000001) return "System.Console" ; 
	if (typeId == 1000002) return "System.IFormatProvider" ; 
	if (typeId == 1000003) return "System.IO.TextWriter" ; 
	if (typeId == 1000004) return "System.Object" ; 
	if (typeId == 1000005) return "System.String" ; 
	return "" ;
}
extern "C" DLL_PUBLIC int HybridizerGetShallowSize (const char* fullTypeName) 
{
	#ifdef __TYPE_DECL__HybC_Program___
	if (strcmp (fullTypeName, "HybC.Program") == 0) return 8 ; 
	#endif
...
extern "C" DLL_PUBLIC int HybCx46Programx46Hello_ExternCWrapper_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared)
{
	CUresult cures ;                                                                                 
	...
	cures = cuModuleGetFunction (&__hybridizer__cufunc, __hybridizer__gs_module.module, "HybCx46Programx46Hello") ;   
	if (cures != CUDA_SUCCESS) return (int)cures ;                                                   
